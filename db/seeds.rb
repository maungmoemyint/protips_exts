...
admin   = User.create!(email: 'admin@epfl.ch', name: 'Admin', password: 'password', role: 'admin')
florian = User.create!(email: 'florian@extensionschool.ch', name: 'Florian', password: 'password', role: 'registered')
sara    = User.create!(email: 'sara@extensionschool.ch',    name: 'Sara', password: 'password', role: 'registered')
linda   = User.create!(email: 'linda@extensionschool.ch',   name: 'Linda', password: 'password', role: 'registered')
...
Tip.create!(title: 'Just experiment!',
            ...
            user:  linda)
Comment.create!(body:    'It is great to learn underscores in number',
                user_id: 3,
                tip_id:  6)
Comment.create!(body:    'It is great to learn about substring',
                user_id: 2,
                tip_id:  2)
Comment.create!(body:    'It is great to learn negative index in arrays',
                user_id: 2,
                tip_id:  3)
Comment.create!(body:    'It is great to learn Multi-line string using %Q',
                user_id: 3,
                tip_id:  5)
Comment.create!(body:    'Agree to the tip just experiment',
                user_id: 1,
                tip_id:  12)
Comment.create!(body:    'Long secret key is great for the security and authentication',
                user_id: 1,
                tip_id:  9)
